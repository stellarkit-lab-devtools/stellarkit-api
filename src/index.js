  ...
  res.json({
    ...
    data: {
      ...
      endpoints: [
        ...
        { method: "GET", path: "/account/:id/trustlines",            description: "Non-native balances with issuer TOML metadata" },
        { method: "GET", path: "/account/:id/analytics",             description: "Lightweight account transaction analytics" },
